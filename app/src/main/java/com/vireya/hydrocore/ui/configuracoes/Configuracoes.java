...
public class Configuracoes extends Fragment {
    ...
    private boolean wifiAtivo = false;
    private boolean notificacaoAtivo = false;
    private boolean offlineAtivo = false;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        setupToggle(view, R.id.toggleWifi, R.id.thumbWifi, () -> wifiAtivo = !wifiAtivo, () -> wifiAtivo);
        setupToggle(view, R.id.toggleNotificacao, R.id.thumbBluetooth, () -> notificacaoAtivo = !notificacaoAtivo, () -> notificacaoAtivo);
        setupToggle(view, R.id.toggleOffline, R.id.thumbOffline, () -> offlineAtivo = !offlineAtivo, () -> offlineAtivo);
    }
...
//                .beginTransaction();
//
//        transaction.replace(R.id.nav_host_fragment_activity_main, new InformacoesConfig());
...
//        transaction.commit();
    ...
    // Visualizar a foto atual em tela cheia
    ...
    // Recebe os resultados (foto tirada ou escolhida)
    @Override
    ...
    private void setupToggle(@NonNull View parentView, int toggleId, int thumbId,
        ...
        toggle.post(() -> {
            ...
            toggle.setOnClickListener(v -> {
                toggleStateCallback.run(); // alterna o estado
                boolean ativo = isActiveCallback.isActive();

                moverThumb(thumb, ativo, deslocamento);
